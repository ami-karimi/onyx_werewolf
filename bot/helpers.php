...
function log_exception( $e )  {
    ...
    // setup notifier
    $API_KEY  = '854021534:AAFdCM0zK9wsk0HyI22eOsEGMG2BmaLlYsI'; // Replace 'XXXXXXXXXX' with your bot's API token
   ...
   // $message  = get_class( $e ) . " - <b>{$e->getMessage()}</b>;".PHP_EOL."File: <b>{$e->getFile()}</b>; Line: <b>{$e->getLine()}</b>; Time: <b>".date("H:i:s / d.m.Y")."</b>;".PHP_EOL."<b>Incoming message:</b><pre>".'</pre>'.PHP_EOL.'<b>Trace:</b><pre>'.$e->getTraceAsString().'</pre>';
...
function log_exception( $e )  {
    ...
    // setup notifier
    $API_KEY  = '854021534:AAGJF8jRcdAVCtIks1sPMOs6HsLakBFkKxc'; // Replace 'XXXXXXXXXX' with your bot's API token
    $DEV_ID   = '-1001162150617'; // Replace 'XXXXXXXXXX' with your Telegram user ID (use /whoami command)
